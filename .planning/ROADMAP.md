...
- [x] 77-01-PLAN.md — History cold-switch pending and snapshot-backed timeline behavior.
...
- [ ] 77-03-PLAN.md — v2.6 local closure matrix, validation metadata, and final gates.
