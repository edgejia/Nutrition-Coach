...
This Railway baseline is retained as historical deployment context. Railway is not the current production runtime path for this repo. Use [production-runtime.md](../production-runtime.md) for current local production-mode runtime and public-domain smoke checks.
