...
- LLM-01 and LLM-03 are documented here. Final LLM-02 completion depends on the non-live evidence artifacts named above and must not be inferred from this ADR alone.
